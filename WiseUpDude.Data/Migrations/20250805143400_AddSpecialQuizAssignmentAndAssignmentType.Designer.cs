...
namespace WiseUpDude.Data.Migrations
{
    ...
    [Migration("20250805143400_AddSpecialQuizAssignmentAndAssignmentType")]
    partial class AddSpecialQuizAssignmentAndAssignmentType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.AssignmentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Quizzes selected for special prominence.",
                            Name = "Featured"
                        },
                        new
                        {
                        ...
                        {
                            Id = 4,
                            Description = "Quizzes with mind-blowing, record-breaking, or 'did you know?' content.",
                            Name = "Wow"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LearningTrackCategories");
                });

            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LearningTrackSourceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LearningTrackSourceId");

                    b.ToTable("LearningTrackQuizzes");
                });

            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuizAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LearningTrackQuizId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LearningTrackQuizId");

                    b.ToTable("LearningTrackQuizAttempts", (string)null);
                });
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuizAttemptQuestion", b =>
                {
                    ...
                    b.Property<int>("LearningTrackAttemptId")
                        .HasColumnType("int");

                    b.Property<int>("LearningTrackQuestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LearningTrackAttemptId");

                    b.ToTable("LearningTrackAttemptQuestions", (string)null);
                });

            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuizQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LearningTrackQuizQuestions");
                });

            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LearningTrackCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LearningTrackCategoryId");

                    b.ToTable("LearningTrackSources");
                });
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.Quiz", b =>
                {
                    ...
                    b.Property<bool>("IsQuizOfTheDay")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("QuizOfTheDayDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.SpecialQuizAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackCategory", b =>
                {
                    b.HasOne("WiseUpDude.Data.Entities.LearningTrack", "LearningTrack")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuiz", b =>
                {
                    b.HasOne("WiseUpDude.Data.Entities.LearningTrackSource", "LearningTrackSource")
                        .WithMany("Quizzes")
                        .HasForeignKey("LearningTrackSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LearningTrackSource");
                });

            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuizAttempt", b =>
                {
                    b.HasOne("WiseUpDude.Data.Entities.LearningTrackQuiz", "LearningTrackQuiz")
                        .WithMany()
                        .HasForeignKey("LearningTrackQuizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LearningTrackQuiz");
                });
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackQuizAttemptQuestion", b =>
                {
                    b.HasOne("WiseUpDude.Data.Entities.LearningTrackQuizAttempt", "LearningTrackAttempt")
                        ...
                        .HasForeignKey("LearningTrackAttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LearningTrackAttempt");
                });
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.LearningTrackSource", b =>
                {
                    b.HasOne("WiseUpDude.Data.Entities.LearningTrackCategory", "LearningTrackCategory")
                        .WithMany("Sources")
                        .HasForeignKey("LearningTrackCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LearningTrackCategory");
                });
            ...
            modelBuilder.Entity("WiseUpDude.Data.Entities.SpecialQuizAssignment", b =>
                {
                    b.HasOne("WiseUpDude.Data.Entities.AssignmentType", null)
                        .WithMany()
                        .HasForeignKey("AssignmentTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WiseUpDude.Data.Entities.UserQuiz", null)
                        .WithMany()
